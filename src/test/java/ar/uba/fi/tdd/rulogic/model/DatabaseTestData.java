...
public final class DatabaseTestData {
  ...
  public static final Database EMPTY_DATABASE =
      DatabaseImpl.builder().statements(ImmutableSet.of()).rules(ImmutableSet.of()).build();

  public static final String SMALL_DATABASE_PATH = "small.db";
  public static final Database SMALL_DATABASE = DatabaseImpl.builder().statements(ImmutableSet.of(
      FactTestData.FACT_1,
      FactTestData.FACT_2,
      FactTestData.FACT_3,
      RuleTestData.RULE)).rules(ImmutableSet.of(RuleTestData.RULE)).build();
